...
const DefaultOIDCLoginTemplate = `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="utf-8">
  <title>Login with OIDC</title>
  <link rel="icon" href="data:;base64,iVBORw0KGgo=">
  <style>
      @import url(https://fonts.googleapis.com/css?family=Open+Sans);
...
<div class="login">
  ...
  <h1>Login to %s</h1>
  <form action="%s" method="post">
    <button class="btn btn-primary btn-block btn-large" type="submit">Login with OIDC provider</button>
  </form>
</div>
</body>
</html>`
